...
public class Test {
	public static void main(String[] args) {
		...
		System.out.println("FCFS: \t " + String.format("%.3f", f.AverageWating) + " \t "
				+ String.format("%.3f", f.AverageTurnAround));
//		System.out.println("\t FCFS: "+String.format("%.3f", f.AverageTurnAround));
		System.out.println(
				"SJF:  \t " + String.format("%.3f", s.avrWating) + " \t " + String.format("%.3f", s.avrTurnAround));
